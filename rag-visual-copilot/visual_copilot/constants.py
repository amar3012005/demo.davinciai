...
ENABLE_PRE_DECISION_GATE = _env_bool("ENABLE_PRE_DECISION_GATE", True)
PRE_DECISION_MODEL = os.getenv("PRE_DECISION_MODEL", "openai/gpt-oss-20b")
PRE_DECISION_TIMEOUT_MS = int(os.getenv("PRE_DECISION_TIMEOUT_MS", "550"))
PRE_DECISION_MAX_COMPLETION_TOKENS = int(os.getenv("PRE_DECISION_MAX_COMPLETION_TOKENS", "800"))
PRE_DECISION_REASONING_LOG_MAX_CHARS = int(os.getenv("PRE_DECISION_REASONING_LOG_MAX_CHARS", "900"))
PRE_DECISION_MIN_CONF = float(os.getenv("PRE_DECISION_MIN_CONF", "0.72"))
