...
SYSTEM_PROMPT = """
You are the console.groq.com Hivemind Compiler. Your mission is to perform a LOSSLESS extraction of Groq Console's structural map and visual targets from raw markdown.
...
def main():
    file_path = "/Users/amar/demo.davinciai/rag-daytona.v2/Visual-co-plan/console_groq.md"
    ...
    output_file = "/Users/amar/demo.davinciai/rag-daytona.v2/extract_payload/console_groq_extracted_hivemind.json"
