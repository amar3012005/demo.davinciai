...
class RedisConfig:
    ...
    def from_env() -> 'RedisConfig':
        ...
        redis_url = os.getenv("TARA_REDIS_URL") or os.getenv("TARA_REDIS_URL") or os.getenv("REDIS_URL")
        if redis_url:
    ...
    def get_redis_url(self) -> str:
        ...
        env_url = os.getenv("TARA_REDIS_URL") or os.getenv("TARA_REDIS_URL") or os.getenv("REDIS_URL")
        if env_url:
            return env_url
