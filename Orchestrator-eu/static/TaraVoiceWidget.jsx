...
const BundBTaraVoiceWidget = ({ config: propConfig }) => {
    const config = useMemo(() => {
        ...
        return {
            ...
            agentId: propConfig?.agentId || globalConfig?.agentId || 'tara',
            agentName: propConfig?.agentName || globalConfig?.agentName || 'Tara',
    ...
    const startVoiceCall = (stream) => {
        ...
        ws.onopen = () => {
            ...
            const sessionConfig = {
                ...
                stt_mode: 'streaming', tts_mode: 'streaming', metadata: { source: 'tara_widget', region: 'EU' }
            };
