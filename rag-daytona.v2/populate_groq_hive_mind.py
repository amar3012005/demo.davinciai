#!/usr/bin/env python3
"""
Populate Qdrant Hive Mind with 'Website Map' hints for Groq.
...
SOURCE_FILE = "/app/daytona_agent/services/rag/groq.md"
    ...
    for line in lines:
        ...
        if line.startswith("## PILLAR"):
            ...
            if len(parts) > 1:
                ...
                upsert_point("demo", url, "Groq - Main Section", "groq.com")
                count += 1
                continue
        ...
        for anchor_text, url in matches:
            ...
            success = upsert_point("demo", url, concept, "groq.com")
            if success:
                count += 1
...
def main():
    print("🚀 Starting Sitemap Ingestion for Groq (Universal Schema v1)...")
