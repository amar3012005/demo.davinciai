...
async def run_router_pre_detective_stage(
    *,
    ...
    if subgoal_hint_query_active and not strategy_authoritative:
    ...
    elif subgoal_hint_query_active and strategy_authoritative:
        logger.info(
            "SUBGOAL_HINT_QUERY_BYPASS: strategy is authoritative; "
            "skipping extra Hive hint queries for deterministic sequence execution."
        )
